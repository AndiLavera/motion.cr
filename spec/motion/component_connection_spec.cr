...
describe Motion::ComponentConnection do
  it "can intialize all dependencies" do
    component_connection = Motion::ComponentConnection.new(MotionRender.new, Motion::Channel.new)
  ...
  it "can process a motion" do
    ...
    component_connection = Motion::ComponentConnection.new(component, Motion::Channel.new)
